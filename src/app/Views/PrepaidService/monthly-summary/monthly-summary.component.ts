...
import { PrepaidDailySummary, PrepaidMonthlySummary } from 'src/app/Model/prepaid-daily-summary';
...
export class MonthlySummaryComponent implements OnInit {
  ...
  onGridReady(params: any) {
    ...
    this.service.getMonthlySummary().subscribe((res: any) => {    

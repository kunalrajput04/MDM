...
@Component({
  selector: 'app-passed-report',
  templateUrl: './passed-report.component.html',
  styleUrls: ['./passed-report.component.css']
})
export class PassedReportComponent implements OnInit {
  ...
  if(this.viewListData){
    ...
    this.rowData = this.viewListData;
      ...
      console.log("here")
      this.route.navigate(['/mdm/vee/MonthlyEstimation']);
    }

...
export class MyMonthlyCellComponent2
  implements OnInit, ICellRendererAngularComp
{
  ...
  onActionClick() {
   ...
   let createdOn = this.params.data.createdOn;
   console.log("ddd");
   console.log(this.params.data.id);
   this.veesr.RunEstimation({ vruleId: id , dataType : 'monthly' ,dateParam: createdOn}).subscribe((res) => {

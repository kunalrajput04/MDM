...
@Component({
  selector: 'app-daily-failed-report',
  templateUrl: './daily-failed-report.component.html',
  styleUrls: ['./daily-failed-report.component.css']
})
export class DailyFailedReportComponent implements OnInit {

...
@Component({
  selector: 'app-details-events-tickets',
  templateUrl: './details-events-tickets.component.html',
  styleUrls: ['./details-events-tickets.component.css'],
})
export class DetailsEventsTicketsComponent implements OnInit {
  //#region  menu
  datas: HeaderMenu = {

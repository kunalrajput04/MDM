...
import { NonCommunicatingComponent } from '../non-communicating/non-communicating.component';
import { DataService } from 'src/app/Service/data.service';
import { CommunicationmeterService } from 'src/app/Service/communicationmeter.service';

@Component({
  selector: 'app-never-communicating-meter',
  templateUrl: './never-communicating-meter.component.html',
  styleUrls: ['./never-communicating-meter.component.css']
})
export class NeverCommunicatingMeterComponent implements OnInit {
  ...
  constructor(
    private service: CommunicationmeterService,
      ...
      (res: any) => {
        ...
        if (res && res.data && Array.isArray(res.data) && res.data.length > 0) {
          ...
          const filteredData = tableDataArray.filter((item: any) => {
            ...
            // Keep only records with null or invalid dates
            return !lastCommDate || isNaN(lastCommDate.getTime());
          });
          ...
          console.log('Mapped Never-Communicated Data:', this.tableData);

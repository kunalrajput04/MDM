...
import { Utility } from 'src/app/Shared/Utility'; // Adjust the path as needed
import { CommunicationmeterService } from 'src/app/Service/communicationmeter.service'; // Adjust the path as needed

@Component({
  selector: 'app-communicating-meter',
  templateUrl: './communicating-meter.component.html',
  styleUrls: ['./communicating-meter.component.css']
})
export class CommunicatingMeterComponent implements OnInit {
  formdata: any = {};
  gridOptions: any;
  defaultColDef: any;
  columnDefs: any;

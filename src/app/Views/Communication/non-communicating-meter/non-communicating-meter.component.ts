...
@Component({
  selector: 'app-non-communicating-meter',
  templateUrl: './non-communicating-meter.component.html',
  styleUrls: ['./non-communicating-meter.component.css']
})
export class NonCommunicatingMeterComponent implements OnInit {
  ...
  datas: HeaderMenu = {
    ...
    url: 'mdm/communication/noncommunicatingmeter',
  };

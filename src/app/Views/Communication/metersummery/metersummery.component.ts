...
@Component({
  selector: 'app-metersummery',
  templateUrl: './metersummery.component.html',
  styleUrls: ['./metersummery.component.css']
})
export class MetersummeryComponent implements OnInit {

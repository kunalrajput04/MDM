...
@Component({
  selector: 'app-sanction-load',
  templateUrl: './sanction-load.component.html',
  styleUrls: ['./sanction-load.component.css'],
})
export class SanctionLoadComponent implements OnInit {
  //#region  menu
  datas: HeaderMenu = {
    firstlevel: 'Instant Demand Service',
    levelurl: '',
    menuname: 'Sanction Load',
    url: '/mdm/prepaid',
  };
